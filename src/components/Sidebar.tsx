...
import { Home, Compass, PlaySquare, Clock, ThumbsUp, SubscriptIcon, History } from "lucide-react";
    ...
    return (
        <aside className="fixed left-0 top-16 w-60 h-[calc(100vh-4rem)] bg-[#0F0F0F] overflow-y-auto hidden md:block z-40">
            <div className="flex flex-col py-3">
                ...
                <SidebarItem icon={<SubscriptIcon className="w-5 h-5" />} label="Subscriptions" />
            </div>
